...
* "Test Procedures"
** "for Single Tileset"
*** "(1) No material is given | Advise & Tile"
*** "(2) materials_for_features.csv | Tile"
...
*** "(8) materials_for_features.csv | Tile"
**** "(10) style-mode : property-based"
**** "(11) transparency : blend"
**** "(12) to custom folder"
*** "(9) my_materials.csv | Tile"
@endmindmap
```
